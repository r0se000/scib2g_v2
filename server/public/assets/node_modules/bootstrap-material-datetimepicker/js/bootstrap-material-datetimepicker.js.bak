(function($, moment) {
    ...
    function Plugin(element, options) {
        ...
        this.params = {
            ...
            format: 'YYYY-MM-DD',
            minDate: null,
            maxDate: yesterday, //최대 어제날짜까지 선택 가능하게 설정
            currentDate: null,
            lang: 'en',
            weekStart: 0,
            disabledDays: [],
    ...
    Plugin.prototype = {
        ...
        initTemplate: function() {
            ...
            this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                ...
                '<div>' +
                '<div class="left center p10" style="color:white;>' +
                '<a href="javascript:void(0);" class="dtp-select-year-before"><i class="icon-arrow-left" style="font-color:white;"></i></a>' +
                '</div>' +
                '<div class="dtp-actual-year p80' + (this.params.year ? "" : " disabled") + '">2014</div>' +
                '<div class="right center p10" style="color:white;>' +
                '<a href="javascript:void(0);" class="dtp-select-year-after"><i class="icon-arrow-right" style="font-color:white;"></i></a>' +
                '</div>' +
                '<div class="clearfix"></div>' +
                '</div>' +
                '</div>' +
