    ...
    private void sendMessage(RemoteMessage remoteMessage, Map<String, String> data, String messageType, String id, String title, String body, boolean showNotification, String sound, String vibrate, String light, String color, String icon, String channelId, String priority, String visibility) {
        ...
        if (showNotification) {
            ...
            if(Build.VERSION.SDK_INT < Build.VERSION_CODES.O){
                ...
                // Uri soundPath = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" +com.sci.edl_h + "/raw/warning");

                notificationBuilder.setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION));
                Log.d(TAG, "Sound: default");

                // Uri soundPath= Uri.parse("android.resource://com.sci.edl_h/raw/warning.mp3");
                // notificationBuilder.setSound(Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://"+ getPackageName() +"/raw/warning.mp3"););
                // Log.d(TAG, "Sound: custom; path="+soundPath.toString());
