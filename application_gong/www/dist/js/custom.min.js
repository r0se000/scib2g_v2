$(function() {
    ...
    }("skin")) && $.inArray(i, a) && s(i), $("[data-skin]").on("click", function(e) { $(this).hasClass("knob") || (e.preventDefault(), s($(this).data("skin"))) }), $("#themeFs").on("click", "a", function() { $("#themecolors li a").removeClass("working"), $(this).addClass("working") }), $(".custom-file-input").on("change", function() {
        var e = $(this).val();
